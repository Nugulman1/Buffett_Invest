...
│   │   ├── 0002_bondyield_company_last_collected_at.py
│   │   ├── 0003_apicallstats.py
│   │   ├── 0004_add_memo_and_calculated_indicators.py
│   │   ├── 0005_company_revenue_cagr.py
│   │   ├── 0006_remove_company_revenue_cagr.py
│   │   ├── 0007_add_roe_filter.py
│   │   ├── 0008_add_memo_updated_at.py
│   │   ├── 0009_favoritegroup_favorite.py
│   │   ├── 0010_change_total_assets_operating_income_ratio_to_operating_margin.py
│   │   ├── 0011_add_quarterly_financial_data.py
│   │   ├── 0012_add_company_name_index.py
│   │   └── 0013_add_company_latest_annual_report.py
...
- **`api_favorites.py`**: 즐겨찾기·그룹 API (`resolve_corp_code` 사용).
