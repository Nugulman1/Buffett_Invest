...
- **기본 지표**: `total_assets`, `operating_income`, `net_income`, `current_liabilities`, `interest_bearing_current_liabilities`, `tangible_asset_acquisition`, `intangible_asset_acquisition`, `cfo`, `interest_expense`, `beta`, `mrp`
